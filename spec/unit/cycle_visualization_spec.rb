...
RSpec.describe Dry::System::CycleVisualization do
  ...
  describe "#generate" do
    let(:visualizer) { described_class.new(%w[test example]) }
  ...
  describe "private methods" do
    let(:visualizer) { described_class.new(%w[alpha beta gamma]) }

    describe "#generate_bidirectional_arrow" do
      it "creates proper bidirectional arrow" do
        visualizer.instance_variable_set(:@cycle, %w[left right])
    ...
    describe "#generate_large_cycle" do
      it "creates compact cycle representation" do
        visualizer.instance_variable_set(:@cycle, %w[a b c d e f])
  ...
  describe "edge cases" do
    ...
    context "with very long component names" do
      it "handles extremely long names" do
        long_name = "a" * 100
